...
public final class ELispBuffer extends AbstractELispIdentityObject {
    ...
    public ELispString subString(long start, long end) {
        ...
        return wrap(content.getValueInRange(new PieceTreeBase.Range(
    ...
    public void erase() {
        ...
        content.compact(); // reset the internal tree
    }
    ...
    public static void initDirectory() {
        ...
        Object handler = BuiltInFileIO.FFindFileNameHandler.findFileNameHandler(dir, true, null);
