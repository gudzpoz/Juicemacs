...
class ELispRegExpOpcode {
    ...
    public static final int OP$STR_START     = 7;
    public static final int OP$STR_END       = 8;
    public static final int OP$LINE_START    = 9;
    public static final int OP$LINE_END      = 10;
    public static final int OP$BUFFER_POINT  = 11;
    public static final int OP$WORD_START    = 12;
    public static final int OP$WORD_END      = 13;
    public static final int OP$WORD_BOUND    = 14;
    public static final int OP$SYMBOL_START  = 15;
    public static final int OP$SYMBOL_END    = 16;
    public static final int OP$SYNTAX_CHAR   = 17;
    public static final int OP$CATEGORY_CHAR = 18;
    public static final int OP$BACKREF       = 19;
    public static final int OP$CHAR_CLASS    = 20;
    public static final int OP$CHAR_CLASS_32 = 21;
    public static final int OP$CHAR          = 22;
    public static final int OP$ANY           = 23;
    ...
    /// - `E`: `OP_FLAG_JMP_JMP/SPLIT`
    /// - `F`: `OP_FLAG_JMP_NOOP/LOOKAHEAD
    /// - `GH`: Reserved
    ///
    /// @see #OP_FLAG_OTHER
    ...
    public static final int OP_FLAG_JMP_JMP        = 0b0_000_0;
    public static final int OP_FLAG_JMP_SPLIT      = 0b0_000_1;
    public static final int OP_FLAG_JMP_KIND_MASK  = 0b0_000_1;
    public static final int OP_FLAG_JMP_KIND_SHIFT = 3;
    public static final int OP_FLAG_JMP_NOOP       = 0b0_000_0_0;
    public static final int OP_FLAG_JMP_LOOKAHEAD  = 0b0_000_0_1;
