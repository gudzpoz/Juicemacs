...
abstract class ELispRegExpOpcode {
    ...
    public static final int OP_LOOKAHEAD_BIT_HASH = 9;
    public static final int OP_LOOKBEHIND_CMP     = 10;
    public static final int OP$STR_START     = 11;
    public static final int OP$STR_END       = 12;
    public static final int OP$LINE_START    = 13;
    public static final int OP$LINE_END      = 14;
    public static final int OP$BUFFER_POINT  = 15;
    public static final int OP$WORD_START    = 16;
    public static final int OP$WORD_END      = 17;
    public static final int OP$WORD_BOUND    = 18;
    public static final int OP$SYMBOL_START  = 19;
    public static final int OP$SYMBOL_END    = 20;
    public static final int OP$SYNTAX_CHAR   = 21;
    public static final int OP$CATEGORY_CHAR = 22;
    public static final int OP$BACKREF       = 23;
    public static final int OP$CHAR_CLASS    = 24;
    public static final int OP$CHAR_CLASS_32 = 25;
    public static final int OP$CHAR          = 26;
    public static final int OP$TRIE          = 27;
    public static final int OP$ANY_BUT       = 28;
    public static final int OP$ANY           = 29;
